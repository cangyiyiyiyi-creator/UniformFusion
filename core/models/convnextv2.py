...
def convnextv2_atto(**kwargs):
    ...
    model.dims = (40, 80, 160, 320)
    return model

def convnextv2_femto(**kwargs):
    model = ConvNeXtV2(depths=[2, 2, 6, 2], dims=[48, 96, 192, 384], **kwargs)
    model.dims = (48, 96, 192, 384)
    return model

def convnext_pico(**kwargs):
    model = ConvNeXtV2(depths=[2, 2, 6, 2], dims=[64, 128, 256, 512], **kwargs)
    model.dims = (64, 128, 256, 512)
    return model

def convnextv2_nano(**kwargs):
    model = ConvNeXtV2(depths=[2, 2, 8, 2], dims=[80, 160, 320, 640], **kwargs)
    model.dims = (80, 160, 320, 640)
    return model
...
def convnextv2_small(**kwargs):
    # model = ConvNeXtV2(depths=[3,3,27,3], dims=[96,192,384,768], **kwargs)
    model = ConvNeXtV2(depths=[3,3,27,3], dims=[96,192,384,768], **kwargs)
    model.dims = (96, 192, 384, 768)     # [ADDED]
    model.num_features = 768             # [ADDED]
    return model
...
def convnextv2_large(**kwargs):
    ...
    model = ConvNeXtV2(depths=[3,3,27,3], dims=[192,384,768,1536], **kwargs)
    model.dims = (192, 384, 768, 1536)   # [ADDED]
    model.num_features = 1536            # [ADDED]
    return model
